...
public final class Lauar {
	...
	public static String getGan(int num) {
		return Gan[num % 10];
	}

	public static String getZhi(int num) {
		return Zhi[num % 12];
	}
...
//		log.debug("SY=" + SY + "SM=" + SM + "SD=" + SD + "sy=" + sy);
	...
	public String getDayGanZhi(int year, int month, int day) {
		Date sDObj;
		int sy;
		sy = (year - 4) % 12;
		System.out.println("SY=" + year + "SM=" + month + "SD=" + day + "sy=" + sy);
//		log.debug("SY=" + year + "SM=" + month + "SD=" + day + "sy=" + sy);
		Calendar cl = Calendar.getInstance();
		...
		//日期
		Lunar1(sDObj); //农历
		return getGan(getDayCyl()) + getZhi(getDayCyl());
	}
